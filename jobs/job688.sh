...
#SBATCH --job-name=688-EVD68-3C-PROA
...
export INPUT="/opt/xchem-fragalysis-2/kfieseler/EV-D68-3C-PROA-syndirella-run/syndirella_input/syndirella_input688.csv"
